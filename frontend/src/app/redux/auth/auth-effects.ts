...
import { AuthenticateFail, AuthenticateSuccess, LoginStart, LOGIN_START, LoadUser, LOAD_USER, REGISTER_START, RegisterStart, LOGOUT, LogoutUser } from './auth-actions-types';
        ...
        .pipe(
          ...
          catchError(errorRes => {
            ...
            if (errorRes.error.errors) {
              openSnackBar(errorRes.error.errors[0].msg, "snackbar-error", this.snackBar);              
            }
